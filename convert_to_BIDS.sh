...
# if session 2:
separateAnatScan=false  # true / false
anatfile= #31331.0c/31331.0c_190228_104042_S3_MPRAGE_ADNI_WE_p2

# If multipel fieldmaps were acquired because the scan was interrupted this needs to be filled in. If not, leave multipleFieldmaps as false, rest empty
multipleFieldmaps=false
fieldmapIDs= ##(7 10)
normInv= ##(4 8)
